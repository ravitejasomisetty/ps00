...
;person-image-list : ListofPerson -> Image
;GIVEN : list of person values
;RETURNS : one image with all person images together


;DESIGN STRATEGY : Functional Composition
(define (person-image-list a)
  (cond [(empty? a) (text "" 20 "red")]
        [else (beside/align "bottom" (person-image (first a)) (person-image-list (rest a)))])
  
  )

(person-image-list (list (make-person "John" "K" 22 50 60) (make-person "Louis" "P" 22 100 60)))
